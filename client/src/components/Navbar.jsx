                ...
                <div className='hidden md:flex items-center gap-6 relative'>
                    ...
                    <div className='relative'>
                        <button onClick={() => {
                            ...
                            setShowUserPopup(false);
                            setShowThemePopup(false);
                        }} className='flex items-center gap-2 bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 px-4 py-2 rounded-full text-sm hover:bg-gray-200 dark:hover:bg-gray-700 transition'>
                            <BsCoin size={18} />
                            {userData?.credits || 0}
                        </button>
                        {showCreditPopup && (
