            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-20">
                    ...
                    <motion.div
                        ...
                        className="lg:col-span-7 bg-white dark:bg-slate-800 p-8 md:p-10 rounded-3xl border border-gray-200 dark:border-slate-700/60 shadow-xs"
                    >
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-gray-200 dark:border-slate-700/60 shadow-xs flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-400 dark:text-gray-500">PATNA, BIHAR 800001</p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="border-t border-gray-200 dark:border-slate-800 pt-16">
                    <motion.h2
                        ...
                        transition={{ duration: 0.5 }}
                        viewport={{ once: true }}
                        className="text-3xl font-extrabold text-gray-900 dark:text-white text-center mb-10 tracking-tight"
                    >
