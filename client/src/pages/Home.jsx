    ...
    <div className='flex flex-col w-full text-gray-900 dark:text-gray-100 transition-colors duration-300'>
      ...
      <section className='relative overflow-hidden'>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-40 -right-40 w-[500px] h-[500px] bg-emerald-400/10 dark:bg-emerald-500/5 rounded-full blur-3xl" />
          <div className="absolute -bottom-40 -left-40 w-[400px] h-[400px] bg-cyan-400/10 dark:bg-cyan-500/5 rounded-full blur-3xl" />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-emerald-300/5 dark:bg-emerald-400/3 rounded-full blur-[100px]" />
        </div>
        ...
        <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:pt-28 pb-20 sm:pb-32'>
          ...
          >
            <div className='animate-float glass dark:glass-dark px-5 py-2.5 rounded-full flex items-center gap-2.5 shadow-lg shadow-emerald-500/5'>
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className='group bg-emerald-600 hover:bg-emerald-500 text-white px-8 py-4 rounded-2xl font-semibold text-base shadow-lg shadow-emerald-600/20 transition-all w-full sm:w-auto flex items-center justify-center gap-3'
            >
              <BsLightning size={18} />
      ...
      <section className='py-20 sm:py-32 px-4 sm:px-6 lg:px-8'>
        <div className='max-w-7xl mx-auto'>
          <motion.div {...sectionAnim} className='text-center mb-16'>
            <div className='inline-flex items-center gap-2 bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-widest mb-4'>
              <BsStar size={12} /> The Workflow
            </div>
            <h2 className='text-3xl sm:text-5xl font-extrabold tracking-tight dark:text-white'>
              Structured <span className="text-emerald-600 dark:text-emerald-400">Preparation</span>
            </h2>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8'>
            {[
              { icon: <BsRobot size={26} />, step: "01", title: "Select Role & Resume", desc: "Upload your resume and choose the specific job title you are targeting to ensure relevant technical questions.", color: "from-emerald-500 to-teal-500" },
              ...
              <motion.div key={index}
                ...
                whileHover={{ y: -8 }}
                className='group relative bg-white dark:bg-slate-900 rounded-3xl border border-gray-100 dark:border-slate-800 p-8 sm:p-10 shadow-sm hover:shadow-2xl hover:shadow-emerald-500/5 transition-all duration-500'
              >
                {/* Step number watermark */}
                <div className='absolute top-6 right-8 text-7xl font-black text-gray-100 dark:text-slate-800/60 select-none transition-colors group-hover:text-emerald-50 dark:group-hover:text-emerald-900/20'>
                  {item.step}
                </div>
      ...
      <section className='py-20 sm:py-32 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900/50 transition-colors'>
        <div className='max-w-7xl mx-auto'>
          <motion.div {...sectionAnim} className='text-center mb-16'>
            ...
            <h2 className='text-3xl sm:text-5xl font-extrabold tracking-tight dark:text-white'>
              Engineered for <span className="text-emerald-600 dark:text-emerald-400">Growth</span>
            </h2>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8'>
            {[
              { image: evalImg, icon: <BsBarChart size={20} />, title: "Contextual Evaluation", desc: "Provides analysis on your responses, evaluating technical depth, clarity, and relevance to the prompted question.", accent: "emerald" },
              ...
              <motion.div key={index}
                ...
                whileHover={{ y: -6 }}
                className='group bg-gray-50 dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-3xl p-6 sm:p-8 hover:shadow-2xl hover:shadow-emerald-500/5 transition-all duration-500 overflow-hidden'
              >
                <div className='flex flex-col sm:flex-row items-center gap-6 sm:gap-8'>
                  ...
                  <div className='w-full sm:w-[55%] text-center sm:text-left'>
                    <div className='bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 w-12 h-12 rounded-2xl flex items-center justify-center mb-4 mx-auto sm:mx-0 shadow-sm'>
                      {item.icon}
                    </div>
      ...
      <section className='py-20 sm:py-32 px-4 sm:px-6 lg:px-8'>
        <div className='max-w-7xl mx-auto'>
          <motion.div {...sectionAnim} className='text-center mb-16'>
            ...
            <h2 className='text-3xl sm:text-5xl font-extrabold tracking-tight dark:text-white'>
              Versatile <span className="text-emerald-600 dark:text-emerald-400">Scenarios</span>
            </h2>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-8'>
            {[
              ...
              <motion.div key={index}
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                whileHover={{ y: -6 }}
                className="group bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-3xl p-6 sm:p-8 hover:shadow-2xl hover:shadow-emerald-500/5 transition-all duration-500"
              >
                <div className='flex items-center justify-between gap-4'>
                  <div className="flex-1 min-w-0">
                    <span className="inline-block text-[10px] font-bold uppercase tracking-wider text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/30 px-2.5 py-1 rounded-lg mb-3">{mode.tag}</span>
      ...
      <section className='px-4 sm:px-6 lg:px-8 pb-20 sm:pb-32'>
        ...
        >
          {/* Background */}
          <div className='absolute inset-0 bg-gradient-to-br from-slate-900 via-slate-800 to-emerald-950 dark:from-slate-950 dark:via-slate-900 dark:to-emerald-950' />
          ...
          <div className='relative z-10 py-16 sm:py-24 px-8 sm:px-16 text-center'>
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className='group relative overflow-hidden bg-emerald-600 hover:bg-emerald-500 text-white px-10 sm:px-14 py-4 sm:py-5 rounded-2xl font-bold text-base sm:text-lg shadow-2xl shadow-emerald-600/30 transition-all w-full sm:w-auto'
              >
