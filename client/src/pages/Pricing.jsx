...
function Pricing() {
  ...
  return (
    <div className='min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-300 py-16 px-6'>
      ...
      >
        <button onClick={() => navigate("/")} className='mt-2 p-3 rounded-full bg-white dark:bg-slate-800 shadow dark:border dark:border-slate-700 hover:shadow-md transition btn-press'>
        ...
        {plans.map((plan) => {
          ...
          return (
            ...
            >
              ...
              {/* Default Tag */}
              {plan.default && (
                <div className="absolute top-6 right-6 bg-gray-200 dark:bg-slate-700 text-gray-700 dark:text-gray-300 text-xs px-3 py-1 rounded-full">
                  Default
                </div>
              )}
