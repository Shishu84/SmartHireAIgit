                ...
                <div className="space-y-8 leading-relaxed">
                    ...
                    <section className="border-t border-gray-200 dark:border-slate-700 pt-8 text-center">
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                            Have questions or concerns about these Terms? Feel free to contact our billing or support panel via the <a href="/contact" className="text-purple-600 dark:text-purple-400 hover:underline font-bold">Contact Page</a>.
                        </p>
                    </section>
                </div>
